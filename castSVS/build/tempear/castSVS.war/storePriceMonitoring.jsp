        ...
        <div class="stockMonitoringContent">
            <table class="stockMonitoringTable">
                <tr class="stockMonitoringTableHeaderCategories">
                    <td></td>
                    <td colspan="2" class="stockMonitoringTableHeaderCell">Price Flow</td>
                </tr>
                    ...
                    <tr class="<c:out value="${trclass}"/>">
                        <td>
                            <fmt:formatDate var="chosenDayString" value="${record.date}" type="date"
                                            pattern="dd/MM/yyyy"/>
                            <a href="storePriceSupervision.jsp?chosenDay=${chosenDayString}">
                                <c:out value="${chosenDayString}"/>
                            </a>
                        </td>
                        <td>
                            <c:choose>
                                <c:when test="${record.priceOkCount < 0}">
                                    -
                                </c:when>
                                <c:otherwise>
                                    <c:out value="${record.priceOkCount}"/>
                                </c:otherwise>
                            </c:choose>
                        </td>
                        <td>
                            <c:choose>
                                <c:when test="${record.priceKoCount < 0}">
                                    -
                                </c:when>
                                <c:otherwise>
                                    <c:out value="${record.priceKoCount}"/>
                                </c:otherwise>
                            </c:choose>
                        </td>
                    </tr>
                ...
                <tr class="stockMonitoringTableHeaderRow">
                    ...
                    <td>
                        <c:choose>
                            <c:when test="${averagePriceOK < 0}">
                                -
                            </c:when>
                            <c:otherwise>
                                <fmt:formatNumber type="percent" value="${averagePriceOK}" minIntegerDigits="2"
                    ...
                    <td>
                        <c:choose>
                            <c:when test="${averagePriceKO < 0}">
                                -
                            </c:when>
                            <c:otherwise>
                                <fmt:formatNumber type="percent" value="${averagePriceKO}" minIntegerDigits="2"
                                                  minFractionDigits="2" maxFractionDigits="2"/>
                            </c:otherwise>
                        </c:choose>
                    </td>
