...
<html>
  <head>
    <title>
      Test du webservice Code Postal.
    </title>
  ...
  <body>
    <h1>Test du webservice Code Postal</h1>
    <div id="sv_wstest_data">
      <form id="sv_wstest_form" action="" method="post">
        <table class="sv_wstest_table">
          <tr>
          <td class="sv_wstest_label"><label for="sv_wstest_postalCode">Code Postal:&nbsp;</label></td>
          <td><input id="sv_wstest_postalCode" type="text" size="35" /></td>
          </tr><tr>
          ...
          <td class="sv_wstest_label"><label for="sv_wstest_size">Taille:&nbsp;</label></td>
          <td><input id="sv_wstest_size" type="text" size="35" /></td>
          </tr><tr>
		  <td colspan="2"><hr/></td>
		  </tr><tr>
          ...
          <td>&nbsp;</td><td><input id="sv_wstest_getstatus" type="button" value="Consulter disponibilit&eacute;" onclick="javascript:getPostalCodeStatus('${pageContext.request.contextPath}');"/></td>
          </tr>
        </table>
      </form>
      ...
      <br />
      <a href="${pageContext.request.contextPath}/svTestByStoreId.jsp">Test du webservice Visu Stock</a>
    </div>
  </body>
</html>