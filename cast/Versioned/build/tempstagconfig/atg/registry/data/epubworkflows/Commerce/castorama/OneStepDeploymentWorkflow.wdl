...
<process author="admin" creation-time="1255499955781" enabled="true" last-modified-by="admin" modification-time="1255500081968">
    ...
    <event id="1">
      ...
      <attributes>
        ...
        <attribute name="atg.workflow.description">
          <constant>A basic workflow which focuses on creating and editing commerce assets. Deploys to staging and production targets.</constant>
        </attribute>
        <attribute name="atg.workflow.displayName">
          <constant>Automatic Deployment Project</constant>
        </attribute>
      </attributes>
    </event>
    <!--================================-->
          ...
          <branch id="4.1.6.1">
            ...
            <fork id="4.1.6.1.2">
              <branch id="4.1.6.1.2.1">
                ...
                <fork exclusive="true" id="4.1.6.1.2.1.5">
                  <branch id="4.1.6.1.2.1.5.1">
                    <!--================================-->
                    <!--== Wait for deployment to complete on target Castorama-Site(Local Dev environment)  -->
                    <!--================================-->
                    <event id="4.1.6.1.2.1.5.1.1">
                      <event-name>atg.deployment.DeploymentStatus</event-name>
                      <filter operator="eq">
                        <event-property>
                          <property-name>targetId</property-name>
                    ...
                    <fork id="4.1.6.1.2.1.5.1.2">
                      <branch id="4.1.6.1.2.1.5.1.2.1">
                        <!--================================-->
                        <!--== Deployment completed event status is success on target Castorama-Site(Local Dev environment)  -->
                        <!--================================-->
                        <condition id="4.1.6.1.2.1.5.1.2.1.1">
                          <filter operator="deploymentCompleted">
                            <constant>1</constant>
                            <constant>tar102</constant>
                          </filter>
                        ...
                        <!--== Validate project is deployed on target Castorama-Site(Local Dev environment)  -->
                        <!--================================-->
                        <action id="4.1.6.1.2.1.5.1.2.1.2">
                          <action-name>validateProjectDeployed</action-name>
                          <action-param name="target">
                            <constant>tar102</constant>
                          </action-param>
