 ...
 */
public class ByPostalCodeURLBuilder
extends StockVisualizationURLBuilder
{
  public ByPostalCodeURLBuilder () {}

  public ByPostalCodeURLBuilder (String pPostalCode, String pProdId, String pChannel, 
		   String pQquantity, String pURLTemplate)
  {
	super (pProdId, pChannel, pQquantity, pURLTemplate);
  ...
  {
	return new String[] {getProdId(), getPostalCode(), 
		   				 getChannel(), getQuantity()};
  }
}
