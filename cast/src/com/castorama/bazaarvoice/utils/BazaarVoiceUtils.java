...
public class BazaarVoiceUtils {
    ...
    public static String encodeUserID(String userID, String userEmailAddress, String sharedKey) {
        if (userID == null) {
            return null;
        }
        return createUserToken(userID, userEmailAddress, sharedKey).toString();
    }
     ...
     * @return a String of hex characters that represents the encoded version of the specified user ID
     */
    public static String encodeUserID(Date time, String userID, String sharedKey) {
        if (userID == null) {
            return null;
        }
        return createUserToken(time, userID, sharedKey).toString();
    }
    
    public static String encodeUserID(Date time, String userID, String userEmailAddress, String sharedKey) {
        if (userID == null) {
            return null;
        }
        return createUserToken(time, userID, userEmailAddress, sharedKey).toString();
    }
    ...
    public static UserToken createUserToken(String userID, String userEmailAddress, String sharedKey) {
        if (userID == null) {
            return null;
        }
        return new UserToken(userID, userEmailAddress, sharedKey);
    }
    
    public static UserToken createUserToken(Date time, String userID, String sharedKey) {
        if (userID == null) {
            return null;
        }
        return new UserToken(time, userID, sharedKey);
    }
    
    public static UserToken createUserToken(Date time, String userID, 
            String userEmailAddress, String sharedKey) {
        if (userID == null) {
            return null;
        }
        return new UserToken(time, userID, userEmailAddress, sharedKey);
    }
    ...
    public static class UserToken {
        ...
        public UserToken(String userID, String sharedKey) {
        	this(new Date(), userID, sharedKey);
        }
        
        public UserToken(String userID, String userEmailAddress, String sharedKey) {
            this(new Date(), userID, userEmailAddress, sharedKey);
        }

        public UserToken(Date time, String userID, String sharedKey) {
            this.sharedKey = sharedKey;
            this.buffer = new StringBuffer();
            add("date", new SimpleDateFormat("yyyyMMdd").format(time));
            add("userid", userID);
		}
        
        public UserToken(Date time, String userID, String userEmailAddress, String sharedKey) {
            this.sharedKey = sharedKey;
            this.buffer = new StringBuffer();
            add("date", new SimpleDateFormat("yyyyMMdd").format(time));
            add("userid", userID);
    ...
    public static String signAndEncode(String string, String sharedKey) {
        ...
        String hexString = encodeHex(string.getBytes());
    ...
    private static byte[] md5(String data) {
        return getMd5Digest().digest(data.getBytes());
    }
