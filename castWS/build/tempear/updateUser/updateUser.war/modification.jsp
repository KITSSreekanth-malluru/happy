...
<dsp:page xml="true">
	...
	<fmt:setBundle basename="com.castorama.identification.TemplateMailModification" />
	...
	<html lang="fra" xmlns="http://www.w3.org/1999/xhtml" xml:lang="fra">
		<head>
			<title><fmt:message key="modification.titre" /></title>
		</head>
		<body link="#000000">
						...
						<table width="520" cellspacing="0" cellpadding="0" align="center">
							<tr>
								<td><br/><font size="2" face="Arial" color="#000000">
									<font size="5" face="Arial" color="#7ecdd0"><fmt:message key="modification.entete" /></font><br/><br/>
									...
									<fmt:message key="modification.texte">
