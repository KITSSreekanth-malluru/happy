...
<%@page import="com.castorama.webservices.clients.ClientCreateUser" %> 
<%@page import="java.util.HashMap" %> 
<%@page import="java.util.Iterator" %> 

<html>
<head>
<title>Test du webservice createUser</title>
<style>
...
<h1>Test du webservice createUser</h1>
...
if (request.getParameter("email") != null || request.getParameter("password") != null || request.getParameter("civilite") != null ||
...
<% String ret = ClientCreateUser.createUser(req, request);	%>
