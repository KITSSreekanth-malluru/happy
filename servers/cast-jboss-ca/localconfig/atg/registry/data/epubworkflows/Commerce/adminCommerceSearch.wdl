...
<process author="admin" creation-time="1208186632423" enabled="true" last-modified-by="admin" modification-time="1464878656773">
  <segment migrate-from="1208188135492,1212163842831,1238437380968" migrate-subjects="true">
    ...
    <fork exclusive="true" id="8">
      ...
      <branch id="8.2">
        ...
        <!--================================-->
        <!--== Approve project for target Castorama-Site(Local Dev environment)  -->
        <!--================================-->
        <action id="8.2.2">
    ...
    <fork exclusive="true" id="12">
      ...
      <branch id="12.2">
        ...
        <!--================================-->
        <!--== Revert assets immediately on target Castorama-Site(Local Dev environment)  -->
        <!--================================-->
        <action id="12.2.2">
