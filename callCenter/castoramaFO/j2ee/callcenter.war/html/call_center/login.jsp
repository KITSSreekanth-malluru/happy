...
--%>
	...
	<TABLE width="400" align="center" border="0" cellspacing="0"
		...
		<TR>
			...
			<TD width="364" bgcolor="#003399" align="center" class="form">Call
			Center</TD>
	...
	<dsp:form action="../vide.jsp" method="POST">
		<dsp:input type="hidden"
			bean="CastoCallCenterProfileFormHandler.loginSuccessURL"
			value="${pageContext.request.contextPath}/html/call_center/login_success.jsp" />
		<dsp:input type="hidden"
	...
	<dsp:droplet name="ErrorMessageForEach">
		...
		<dsp:oparam name="output">
			<SPAN class="texterou"><img src="../img/flecheb_retrait.gif" border="0"><dsp:valueof param="message" /></span><br />		
		</dsp:oparam>
	</dsp:droplet>
