...
var tmpflash = '';
function putMyFlash(version,SEOPage) {
	var flashContent=document.getElementById('flashContent');	
	if(urlSuppl&&SEOPage)urlSuppl+="&"+SEOPage;
	else urlSuppl+="?"+SEOPage;
	tmpflash += '<OBJECT  type="application/x-shockwave-flash" data="'+version+'.swf'+urlSuppl+'" style="display:block;width:100%;height:100%;margin:0;" id="flashpiece">';
	tmpflash += '<PARAM NAME="movie" VALUE="'+version+'.swf'+urlSuppl+'">';
