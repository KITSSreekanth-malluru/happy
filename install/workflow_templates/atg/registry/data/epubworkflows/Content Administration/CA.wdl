...
<process author="admin" creation-time="1208186632423" enabled="true" last-modified-by="admin" modification-time="1238437507875">
  <segment migrate-from="1208188135492,1212163842831" migrate-subjects="true">
    ...
    <event id="1">
      ...
      <filter operator="eq">
        ...
        <constant>/Content Administration/CA.wdl</constant>
      </filter>
      <filter operator="eq">
        <event-property>
