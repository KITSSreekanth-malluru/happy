...
<process author="admin" creation-time="1208186632423" enabled="true" last-modified-by="admin" modification-time="1238539842718">
  <segment migrate-from="1208188135492,1212163842831" migrate-subjects="true">
    ...
    <event id="1">
      ...
      <filter operator="eq">
        ...
        <constant>/Personalization/editSegmentsAndTargeters.wdl</constant>
      </filter>
      <filter operator="eq">
        <event-property>
      ...
      <attributes>
        ...
        <attribute name="atg.workflow.description">
          <constant>A basic workflow which focuses on creating and editing user segments, content groups, and targeters. Deploys to production target.</constant>
        </attribute>
        <attribute name="atg.workflow.displayName">
          <constant>Targeting and Segmentation</constant>
        </attribute>
      </attributes>
    </event>
    <!--================================-->
    ...
    <fork exclusive="true" id="8">
      <branch id="8.1">
        ...
        <!--================================-->
        <!--== Approve and deploy project to target CommerceOnDemand  -->
        <!--================================-->
        <action id="8.1.2">
      ...
      <branch id="8.2">
        ...
        <!--================================-->
        <!--== Approve project for target CommerceOnDemand  -->
        <!--================================-->
        <action id="8.2.2">
    ...
    <fork exclusive="true" id="10">
      <branch id="10.1">
        <!--================================-->
        <!--== Wait for deployment to complete on target CommerceOnDemand  -->
        <!--================================-->
        <event id="10.1.1">
        ...
        <fork id="10.1.2">
          <branch id="10.1.2.1">
            <!--================================-->
            <!--== Deployment completed event status is success on target CommerceOnDemand  -->
            <!--================================-->
          ...
          <branch id="10.1.2.2">
            <!--================================-->
            <!--== Deployment completed event status is failure on target CommerceOnDemand  -->
            <!--================================-->
    ...
    <fork exclusive="true" id="12">
      <branch id="12.1">
        ...
        <!--================================-->
        <!--== Validate project is deployed on target CommerceOnDemand  -->
        <!--================================-->
        <action id="12.1.2">
      ...
      <branch id="12.2">
        ...
        <!--================================-->
        <!--== Revert assets immediately on target CommerceOnDemand  -->
        <!--================================-->
        <action id="12.2.2">
