<dsp:page>
  ...
  <dsp:getvalueof var="magasinFST" param="magasinFST"/>
  ...
  <c:if test="${fn:length(facetValuesResultListVar) > facetRowAmount}">
    ...
    <div class="autres">
      ...
      <div id="addMorePopup_${ajouterFacetId}" class="autresPopup ajouterListMagasinContainer${ajouterFacetId}" style="display: none;">                              
        <div class="icoPpTop">
        ...
        <dsp:droplet name="/com/castorama/search/droplet/AjouterTableRenderer">
          ...
          <dsp:oparam name="outputTableStart">
            ...
            <style type="text/css">
              .ajouterListMagasinContainer${ajouterFacetId} {
                width: ${width}px;
              }
            </style>
          </dsp:oparam>
