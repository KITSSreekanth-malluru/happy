                ...
                <dsp:oparam name="false">
                  ...
                  <c:choose>
                    <c:when test="${not empty containerVar && fn:contains(containerVar, '?')}">
                      <c:set var="actionContainerVar" value="${containerVar}&formid=${formid }&osearchmode=${osearchmode}"/>
                    </c:when>
                    <c:otherwise>
                       <c:set var="actionContainerVar" value="${containerVar}?formid=${formid }&osearchmode=${osearchmode}"/>
                    </c:otherwise>
                  ...
                  <dsp:form action="${actionContainerVar}" method="post" iclass="ajouterListForm${ajouterFacetId}">
