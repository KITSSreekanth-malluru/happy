<dsp:page>
  ...
  <td class="firstCell">
      ...
      <dsp:droplet name="For">
        ...
        <dsp:oparam name="output">
          ...
          <dsp:getvalueof var="quantityImg" param="sku.bundleLinks[param:index].quantity"/>
              ...
              <c:if test="${empty carouselImage}">
                <dsp:getvalueof var="carouselImage" value="/default_images/b_no_img.jpg"/>
              </c:if>
          <dsp:a href="${contextPath}${templateUrl}" style="background: url(${carouselImage}) 0px 0px;">
           
              <span style="width:15px;height:15px;background-color:#2d89d1;font-size:10px;line-height:14px;color:#fff!important">
    ...
    <div class="productItemDescription" style="display:block;">
      <h3>
