                ...
                <td>
                  ...
                  <font size="2" face="Arial" color="#000000">
                    <font size="3" face="Arial" color="#09438b"><b>
                      <fmt:message key="email.message.received.title">
                    ...
                    <p><b>
                      <fmt:message key="email.message.common.service.message">
                        <fmt:param><fmt:formatDate value="${orderMoveToPaymentDate }" type="date" dateStyle="long"/></fmt:param>
                      </fmt:message>
                    </b></p>
                    ...
                    <p><br />
                      <fmt:message key="email.message.received.clientspace">
                        <fmt:param>
