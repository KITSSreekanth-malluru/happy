<dsp:page>
    ...
    <dsp:importbean bean="/com/castorama/payment/PaymentConfiguration"/>
    ...
    <dsp:droplet name="CastOrderCheckoutValidatorDroplet">
        ...
        <dsp:param name="pbx_total" param="PBX_TOTAL"/>
        <dsp:oparam name="false">
            <dsp:droplet name="/atg/dynamo/droplet/Redirect">
                <dsp:param name="url" value="../../../checkout/cart.jsp?invalidOrder=true"/>
            </dsp:droplet>
        </dsp:oparam>
        <dsp:oparam name="true">
            ...
            <c:choose>
                <c:when test="${orderDeliveryType == 'clickAndCollect'}">
                    <dsp:droplet name="/com/castorama/droplet/CastLookupDroplet">
                        ...
                        <dsp:param name="id" bean="/atg/commerce/ShoppingCart.currentlySelected.magasinId"/>
           ...
           <c:choose>
            ...
            <dsp:droplet name="/com/castorama/droplet/PayboxHandledDroplet">
                ...
                <dsp:param name="source" value="PORTAL"/>
                <dsp:oparam name="output">
                ...
                <dsp:oparam name="empty">
                    <dsp:droplet name="/atg/dynamo/droplet/Redirect">
                        <dsp:param name="url" value="${shost}/checkout/cart.jsp"/>
                    </dsp:droplet>
                </dsp:oparam>
            </dsp:droplet>
        </dsp:oparam>
