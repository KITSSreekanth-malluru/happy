<dsp:page>
  ...
  <dsp:droplet name="/com/castorama/search/droplet/AjouterDocumentFacetValuesFinder">
    ...
    <dsp:oparam name="output">
      ...
      <dsp:droplet name="/com/castorama/search/droplet/CastFacetValuesDroplet">
        ...
        <dsp:oparam name="oparam">
          <dsp:droplet name="/com/castorama/search/droplet/CastDocFacetedPropertyDroplet">
            ...
            <dsp:oparam name="output">
              ...
              <dsp:droplet name="/atg/dynamo/droplet/IsEmpty">
                ...
                <dsp:oparam name="false">
                  ...
                  <c:choose>
                    <c:when test="${not empty docContainerVar && fn:contains(docContainerVar, '?')}">
                      <c:set var="actionContainerVar" value="${docContainerVar}&formid=${formid }&osearchmode=${osearchmode}"/>
                    </c:when>
                    <c:otherwise>
                       <c:set var="actionContainerVar" value="${docContainerVar}?formid=${formid }&osearchmode=${osearchmode}"/>
                    </c:otherwise>
                  ...
                  <div class="icoPpTop"><img title="" alt="" src="${contextPath }/images/icoPpTop.gif"/></div>
                   
                  <dsp:form action="${actionContainerVar }" method="post" id="${formid }" iclass="ajouterListDocumentForm${ajouterFacetId}">
                    ...
                    <input type="hidden" name="ajouterDocumentSearchRequest" value="true"/>
                    ...
                    <dsp:droplet name="/com/castorama/search/droplet/AjouterTableRenderer">
                      ...
                      <dsp:oparam name="outputTableStart">
                        ...
                        <style type="text/css">
                          .ajouterListDocumentForm${ajouterFacetId} {
                            width: ${width}px;
                          }
                        </style>
                      </dsp:oparam>
                      ...
                      <dsp:oparam name="output">
                        ...
                        <div class="iOpt" style="width: ${ajouterColumnWidth}px">
                          ...
                          <label for="ajouter_${ajouterFacetId}:${facetValue.value }">
